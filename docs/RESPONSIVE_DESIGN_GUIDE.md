...
;<motion.button className="lg:hidden">{/* Hamburger menu */}</motion.button>
```
...
```tsx
<div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">{/* Innehåll */}</div>
```
...
;<div className="py-8 sm:py-16 md:py-24">{/* xs: 8px, sm: 16px, md: 24px, lg: 32px, etc. */}</div>
```
  ...
  return (
    <section className="py-8 sm:py-16 md:py-24 lg:py-32">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
        ...
        <h2 className="text-h2 text-center md:text-left mb-8">Rubrik</h2>
