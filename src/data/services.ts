...
export const services: Service[] = [
  ...
  },
  {
    ...
    longDesc:
      'Vi bygger hemsidor som är snabba, responsiva och användarvänliga. Tekniken är osynlig – det som syns är en smidig upplevelse som bara fungerar. Vår kod är ren, välstrukturerad och optimerad för att säkerställa att din hemsida inte bara ser bra ut, utan också presterar utmärkt. Vi använder modern teknik som Next.js, React och TypeScript, kombinerat med AI-verktyg för effektiv utveckling och kodgenerering.',
    features: [
