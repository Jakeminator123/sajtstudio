...
/**
 * Contact page - renamed from /contact to /kontakt
 *
 * NOTE: The old /contact URL is kept as a redirect or will be handled
 * by the catch-all slug route. Update all internal links to use /kontakt.
 *
 * API endpoint remains at /api/contact for backwards compatibility.
 */
    ...
    return (
      <div className="text-center" suppressHydrationWarning>
        ...
        <p className="text-white/70 text-sm uppercase tracking-wider">
          ...
          <span className="text-red-400">Sverige</span>
        </p>
      </div>
    )
  }
              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  <motion.div whileHover={{ x: 10 }} className="group">
                    ...
                    <p
                      className={`text-xl md:text-2xl ${isLight ? 'text-gray-800' : 'text-white'}`}
                    >
                      <span className={isLight ? 'text-gray-800' : 'text-white'}>Stockholm</span>,{' '}
                      <span className="text-red-500">Sverige</span>
                    </p>
                  </motion.div>
                </div>
