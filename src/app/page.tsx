...
const ProcessSection = dynamic(
  () => import("@/components/sections/ProcessSection").catch(() => ({ default: () => <SectionSkeleton /> })),
  {
...
const TestimonialsSection = dynamic(
  () => import("@/components/sections/TestimonialsSection").catch(() => ({ default: () => <SectionSkeleton /> })),
  {
    loading: () => <SectionSkeleton />,
  }
);
...
const BigCTA = dynamic(
  () => import("@/components/sections/BigCTA").catch(() => ({ default: () => <SectionSkeleton /> })),
  {
    loading: () => <SectionSkeleton />,
  }
);
...
const OpticScrollShowcase = dynamic(
  () => import("@/components/sections/OpticScrollShowcase").catch(() => ({ default: () => <SectionSkeleton /> })),
  {
    loading: () => <SectionSkeleton />,
