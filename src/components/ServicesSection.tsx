...
function ServiceItem({ number, title, description, delay = 0 }: ServiceItemProps) {
      ...
      <div className="pt-16 pb-20 relative z-10">
        <div className="flex items-start gap-8">
          ...
          <motion.span 
            ...
            transition={{ duration: 0.8, delay: delay + 0.3, ease: [0.34, 1.56, 0.64, 1] }}
          ...
          <motion.div 
            ...
            transition={{ duration: 0.8, delay: delay + 0.4, ease: [0.25, 0.1, 0.25, 1] }}
          >
            <motion.h3 
  ...
  const services = [
    {
      number: '01',
      title: 'Modern Design',
      description: 'Vi skapar visuellt imponerande hemsidor som fångar besökarens uppmärksamhet och kommunicerar ditt varumärkes värde på ett kraftfullt sätt.',
    },
    {
      number: '02',
      title: 'Teknisk Excellens',
      description: 'Varje hemsida är byggd med senaste tekniker för optimal prestanda, säkerhet och sökmotoroptimering. Snabb, säker och skalbär.',
    },
    {
      number: '03',
      title: 'Skräddarsydda Lösningar',
      description: 'Inga mallar eller generiska lösningar. Varje projekt är unikt designat och utvecklat specifikt för ditt företags behov och mål.',
    },
  ];
