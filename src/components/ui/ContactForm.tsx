...
export default function ContactForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        <label htmlFor="email" className="block text-sm font-medium mb-3 text-white/80 uppercase tracking-wider">
          E-post
        </label>
        <input
          type="email"
      ...
      <div>
        <label htmlFor="message" className="block text-sm font-medium mb-3 text-white/80 uppercase tracking-wider">
          Meddelande
        </label>
        <textarea
          id="message"
      ...
      <AnimatePresence mode="wait">
        ...
        {formState.status === "error" && (
          <motion.div
            ...
            aria-live="assertive"
          >
            <span className="text-red-400">⚠️</span> Något gick fel. Kontrollera att alla fält är ifyllda korrekt och försök igen.
          </motion.div>
        )}
      </AnimatePresence>
