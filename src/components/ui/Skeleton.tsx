...
export default function Skeleton({
  ...
  const dynamicClass = useMemo(() => {
    const key = `${widthValue}__${heightValue}`.toLowerCase().replace(/[^a-z0-9_-]+/g, '_')
  ...
  const skeletonElement = (
    <div className={`${baseClasses} ${variantClasses[variant]} ${className} ${dynamicClass}`}>
      {animation && (
        <motion.div
    ...
    <div className="py-16 sm:py-24 md:py-32 lg:py-48">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-16">
          <Skeleton variant="text" width="50%" height="3rem" className="mx-auto mb-4" />
    ...
    <section className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-black">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <Skeleton variant="text" width="90%" height="4rem" className="mx-auto" />
          <Skeleton variant="text" width="70%" height="4rem" className="mx-auto" />
          <div className="pt-8">
            <Skeleton variant="text" width="60%" height="1.5rem" className="mx-auto mb-8" />
