      ...
      >
        ...
        <nav className="container mx-auto px-6 py-4" style={{ position: 'relative' }}>
          <div className="flex items-center justify-between" style={{ position: 'relative' }}>
            ...
            {/* Desktop Navigation */}
            <nav className="hidden lg:flex items-center gap-8 relative" style={{ position: 'relative' }}>
              <div className="flex items-center gap-1 relative" style={{ position: 'relative' }}>
