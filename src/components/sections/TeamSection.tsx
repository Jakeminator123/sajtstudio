        ...
        <motion.div
          className={`absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r ${
            index === 0
              ...
              : index === 1
                ? 'from-rose-500 via-orange-400 to-rose-500'
...
export default function TeamSection() {
  ...
  const intro = getValue(
    'T53',
    'Sajtstudio drivs av ett dynamiskt team av entreprenörer med bred erfarenhet inom teknik, media och affärer.'
  )
  const outro = getValue(
    'T63',
    'Tillsammans kombinerar vi teknisk expertis, kreativ marknadsföring och affärssinne.'
  )
  ...
  const teamMembers = [
    {
      ...
      description: getValue(
        'T60',
        'En före detta professionell pokerspelare som bytte karriärbana till tech-världen. Med flera års erfarenhet av programmering och mjukvaruutveckling ansvarar han för den tekniska utvecklingen.'
      ),
    ...
    },
    {
      ...
      description: getValue(
        'T61',
        'En serieentreprenör som har drivit flera digitala projekt och företag. Han har byggt och sålt webbplatser samt varit involverad i olika tech-startups.'
      ),
    ...
    },
    {
      ...
      description: getValue(
        'T62',
        'Vår expert inom media och marknadsföring med över ett decennium i branschen. Han ansvarar för innehållsstrategi och SEO.'
      ),
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
        ...
        >
          ...
          >
            En av våra medgrundare driver exempelvis ett kontorshotell i centrala Stockholm – en
            kreativ coworking-miljö där entreprenörer och utvecklare möts. Denna koppling speglar
            vårt engagemang i startup-världen och tekniksfären, vilket ger oss insikt i de
            utmaningar och möjligheter som moderna företag står inför.
          </motion.p>
        </motion.div>
        ...
        >
          <p className="text-lg md:text-xl text-gray-300 leading-relaxed mb-6">{outro}</p>

          <p className="text-base text-gray-400 leading-relaxed mb-8">
            Vi på Sajtstudio tar hand om din webbplats – så att du kan ta hand om din verksamhet. Vi
            tror på transparens och trovärdighet, och är stolta över den erfarenhet vi tar med oss
            in i varje nytt samarbete. När du arbetar med Sajtstudio får du inte bara en snygg
            hemsida, utan även en partner med djup förståelse för webb, media och affärer – redo att
            hjälpa ditt företag att växa online.
          </p>
