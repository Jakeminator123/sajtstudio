      ...
      >
        <div className="absolute inset-0 pointer-events-none">
          <motion.div
            ...
            style={{
              opacity: starOpacity,
              background: `radial-gradient(circle at 70% 0%, ${accent}66, transparent 50%)`,
            }}
          />
          <motion.div
            className="absolute inset-0"
            style={{ y: parallaxBackY }}
          >
        ...
        <div className="relative z-10 grid lg:grid-cols-[0.9fr_1.1fr] gap-12 lg:gap-20 items-start">
          <motion.div style={{ y: copyYValue, opacity: copyOpacityValue }}>
              ...
              >
                <div className="absolute inset-0 pointer-events-none mix-blend-screen">
                  ...
                  <motion.div
                    className="absolute inset-0"
                    style={{
                      background: `radial-gradient(circle at 80% 60%, ${tertiary}25, transparent 60%)`,
                      opacity: haloOpacity,
                    }}
                  />
                </div>
                ...
                <motion.div className="absolute inset-0 pointer-events-none perspective-[800px]">
                  <motion.div
                    ...
                    style={{ x: img1X, y: img1Y, rotateZ: img1Rot, opacity: img1Opacity }}
                  >
                    <Image src="/images/portfolio/assets_task_01k05sqa0wedsbvfk5c0773fz5_1752541456_img_0.webp" alt="" fill className="object-cover rounded-lg shadow-lg" />
                  </motion.div>
                  <motion.div
                    className="absolute right-1/3 top-1/3 w-40 h-24"
                    style={{ x: img2X, y: img2Y, rotateZ: img2Rot, opacity: img2Opacity }}
                  >
                    <Image src="/images/portfolio/assets_task_01k1c880wqft0s0bcr3p77v2me_1753831780_img_0.webp" alt="" fill className="object-cover rounded-lg shadow-lg" />
                  </motion.div>
                  <motion.div
                    className="absolute left-1/2 top-1/2 w-32 h-20"
                    style={{ translateX: "-50%", translateY: "-50%", scale: img3Scale, opacity: img3Opacity, rotateX: 35 }}
                  >
                    <Image src="/images/portfolio/assets_task_01k80qdg0ze1rskjzfpj7r1za3_1760961264_img_0.webp" alt="" fill className="object-cover rounded-lg shadow-lg" />
                  </motion.div>
                </motion.div>
              </motion.div>
                  ...
                  <div className="relative h-32 w-px bg-white/15 overflow-hidden">
                    <motion.div
                      ...
                      style={{
                        ...
                        originY: 0,
                        background: `linear-gradient(to bottom, ${accent}, ${white}, ${tertiary})`,
                      }}
                    />
                  </div>
                  <div className="text-right">
