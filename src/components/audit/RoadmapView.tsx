            ...
            {phases.map((phase, index) => {
              ...
              return (
                <motion.button
                  ...
                  className={`relative z-10 ${selectedPhase === phase.key ? 'scale-110' : ''}`}
                >
                  <div
          ...
          {phases.map((phase, index) => {
            ...
            return (
              <motion.div
                ...
                className={`relative p-6 rounded-2xl border bg-gradient-to-br ${getPhaseColor(
                  phase.color
      ...
      {selectedPhase && roadmap[selectedPhase] && (
        ...
        >
          <h4 className="text-xl font-bold text-white mb-6 flex items-center gap-3">
            <span className="text-2xl">{phases.find((p) => p.key === selectedPhase)?.icon}</span>
