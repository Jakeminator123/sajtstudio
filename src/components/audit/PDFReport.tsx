  ...
  <Document>
    <Page size="A4" style={styles.page}>
            ...
            .map((improvement: Improvement, index: number) => (
              <View key={index} style={styles.improvementItem}>
                ...
                {improvement.estimated_time && (
                  <Text
                    style={[styles.text, { fontStyle: "italic", fontSize: 10 }]}
                  >
          ...
          {result.budget_estimate.immediate_fixes && (
            <View style={{ marginBottom: 10 }}>
              <Text style={styles.text}>
                ...
                {result.budget_estimate.immediate_fixes.low.toLocaleString(
                  "sv-SE"
                )}{" "}
                -{" "}
          ...
          {result.budget_estimate.full_optimization && (
            <View style={{ marginBottom: 10 }}>
              <Text style={styles.text}>
                ...
                {result.budget_estimate.full_optimization.low.toLocaleString(
                  "sv-SE"
                )}{" "}
                -{" "}
      ...
      {(result.security_analysis ||
        ...
        result.technical_recommendations) && <View break />}
      ...
      {result.security_analysis && (
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            <Text style={styles.bold}>HTTPS Status:</Text>{" "}
            {result.security_analysis.https_status}
          </Text>
          <Text style={styles.text}>
            <Text style={styles.bold}>Säkerhetshuvuden:</Text>{" "}
          ...
          {result.security_analysis.vulnerabilities &&
            result.security_analysis.vulnerabilities.length > 0 && (
              <View style={{ marginTop: 10 }}>
                ...
                {result.security_analysis.vulnerabilities.map(
      ...
      {result.competitor_insights && (
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            <Text style={styles.bold}>Branschstandarder:</Text>{" "}
            {result.competitor_insights.industry_standards}
          </Text>
          <Text style={[styles.text, { marginTop: 10 }]}>
            <Text style={styles.bold}>Saknade funktioner:</Text>{" "}
            {result.competitor_insights.missing_features}
          </Text>
          <Text style={[styles.text, { marginTop: 10 }]}>
            <Text style={styles.bold}>Unika styrkor:</Text>{" "}
      ...
      <Text style={styles.footer}>
        Genererad av SajtStudio AI-driven webbanalys |{" "}
