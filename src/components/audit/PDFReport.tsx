  ...
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View>
        ...
        {result.company && <Text style={styles.subtitle}>{result.company}</Text>}
        {result.domain && (
          ...
          {result.budget_estimate.immediate_fixes && (
            <View style={{ marginBottom: 10 }}>
              <Text style={styles.text}>
                ...
                {result.budget_estimate.immediate_fixes.high.toLocaleString('sv-SE')}{' '}
          ...
          {result.budget_estimate.full_optimization && (
            <View style={{ marginBottom: 10 }}>
              <Text style={styles.text}>
                ...
                {result.budget_estimate.full_optimization.high.toLocaleString('sv-SE')}{' '}
                {result.budget_estimate.currency}
              </Text>
            </View>
          )}
